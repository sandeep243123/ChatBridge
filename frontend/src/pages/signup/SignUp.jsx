   ...
   return (
     <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <Link to={'/login'} className='text-sm hover-underline hover:text-blue-600 mt-2 inline-block text-gray-400' >Already have an account?</Link>
            <div>
                <button className='btn btn-block btn-sm mt-2 border-slate-700' disabled={loading}>
                    {loading?<span className="loading loading-spinner text-gray-400" ></span>: "SignUp"}
                    </button>
            </div>
        </form>
        </div>
